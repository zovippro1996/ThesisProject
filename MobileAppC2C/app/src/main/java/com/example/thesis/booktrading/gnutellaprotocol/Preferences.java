...
public class Preferences
{
    ...
    public static String SAVEPATH = "/ccrick";

    public static void readFromFile(String preferencesPath)
    {
        try
        {
            File preferenceFile = new File(preferencesPath);
//            BufferedReader fileIn = new BufferedReader(new FileReader(FILE_NAME));
            BufferedReader fileIn = new BufferedReader(new FileReader(preferenceFile));
            String line;
    ...
    public static void writeToFile(String preferencesPath)
    {
        try
        {
            PrintWriter fileOut = new PrintWriter(new FileWriter(preferencesPath));
